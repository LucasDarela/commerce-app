...
const NotFoundAnimation = dynamic(() => import("@/components/not-found-animation"), {
  ssr: false,
})
...
export default function NotFound() {
  return (
    <div className="bg-white min-h-screen flex flex-col items-center justify-center text-center px-4">
      <NotFoundAnimation />
      <h1 className="text-md sm:text-md font-bold mb-2 text-black">404 - Página não encontrada</h1>
